...
Our test run shows that the code runs for less than 3 hours and generates about 2 Gb of data.

Here are the ouputs from shell script:
...
def maintask():
    ...
    with open(data_file, 'w', buffering=1) as f:
        ...
        while True:
            ...
            writer.writerow(row)
            if not counter%5: #approx. every 25 seconds for photos.
            ...
            sleep(5) #Sensor data every 5 seconds.
...
#These threads run in the background and finish when the main program finishes.
